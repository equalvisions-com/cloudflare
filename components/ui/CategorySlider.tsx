          ...
          {categories.map((category, index) => (
            <button
              ...
              className={cn(
                ...
                "after:absolute after:bottom-0 after:left-0 after:w-full after:transition-all after:duration-200 after:rounded-full",
                category._id === selectedCategoryId
                  ? "text-primary after:bg-primary after:h-[.25rem]"
                  : "text-muted-foreground hover:text-foreground after:h-0 after:-mb-[.25rem]"
              )}
